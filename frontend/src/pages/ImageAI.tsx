          ...
          {!promptReady && !imageSrc && (
            <div className="text-center py-6">
              ...
              <p className="text-white/40 text-sm max-w-xs mx-auto">
                Describe any idea — Llama converts it to the perfect prompt, then DALL-E 3 brings it to life.
              </p>
            </div>
          )}
            ...
            <div className="bg-white/[0.04] border border-white/[0.07] rounded-2xl p-5">
              ...
              {genLoading && (
                <p className="text-[11px] text-white/20 mt-2 px-1">
                  Pahilo pali Puter.com account login popup aaulacha — free account, ekpali matra
                </p>
              )}
            </div>
          )}
          ...
          {imageSrc && (
            <div className="bg-white/[0.04] border border-white/[0.07] rounded-2xl overflow-hidden">
              <div className="relative">
                <img src={imageSrc} alt="Generated by DALL-E 3" className="w-full object-cover" />
